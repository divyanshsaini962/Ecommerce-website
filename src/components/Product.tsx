...
import { addToCart } from '@/redux/sainiindus';
...
const dispatch = useDispatch()
  ...
  return (
     ...
     shadow-gray-500 rounded-md overflow-hidden group'>
        <div className='w-full  h-8- flex items-center justify-center overflow-hidden bg-white '>
            <div className={`relative ${bg}`}>
               ...
               <div className='absolute bottom-0 flex items-center gap-5 justify-center translate-y-[110%]
               group-hover:-translate-y-2 transition-transform duration-300'>
                  <button 
                    ...
                    className='bg-gray-800 text-gray-200 px-4 py-2 text-xs rounded-full flex items-center gap-1 
                ...
                {product?.isnew && (
                 <div className='absolute top-2 right-2 z-50'>
                    <p className='bg-primaryColor px-2 py-2 text-white flex justify-center items-center text-sm
                    font-semibold hover:bg-black duration-300 cursor-pointer rounded-md'>New</p>
                 </div>
                 )
            }
            </div>
        ...
        <div className='max-w-80 py-6 flex flex-col gap-1 px-4'>
          ...
          <div>
            <p className='text-[#767676] text-sm'>a poduct by{" "} 
            <span className='font-semibold text-pimeColor'>{product?.brand}</span>
            </p>
